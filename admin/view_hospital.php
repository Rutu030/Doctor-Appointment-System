                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Hospitals <span class="table-project-n">Details</span></h1>
                                </div>
                            </div>
                                    ...
                                    <table style="font-weight: bold;" id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                             <a href="data_hospital.php?did='.$row[0].'">
                                                
                                                     <center> 
                                                           
                                                           <i class="fa fa-user" aria-hidden="true" style="font-size: 20px;color: gray;"></i>
                                                ...
                                                <td>
                                                    ...
                                                    <center> 
                                                             <a href="update_hospital.php?did='.$row[0].'">
                                                 ...
                                                 <td>
                                                    <a href="delete_hospital.php?id='.$row[0].'">
